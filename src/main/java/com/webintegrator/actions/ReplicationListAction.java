/*
 * Implements server side of a 'Edit Replication' functionality
 */
 ...
 * @author slava
 */
public class ReplicationListAction extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       String replicationname = request.getParameter("replication");
